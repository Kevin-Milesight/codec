// bosch tps110 — LoRaWAN payload decoder
// 字段清单来自官方 payload 说明（协议事实）；解析逻辑为自实现。
"use strict";
var FIELDS = ["magnetometer","gps","temperature","people_count","occupied","firmwareversion","resetcause","timestamp","debugcode","sequencenumber"];
