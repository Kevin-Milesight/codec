...
var ELSYS_KEY_MAP = {
  ...
  "y": "acceleration_y",
  "z": "acceleration_z",
  "accMotion": "acceleration_movements",
  "analog1": "analog_1",
  "analog2": "analog_2",
  "pulse1": "pulse_count",
  "pulse2": "pulse_count_2",
  "pulseAbs": "pulse_count_abs",
  "pulseAbs2": "pulse_count_2_abs",
  "externalTemperature": "external_temp_1",
  "externalTemperature2": "external_temp_2",
  "digital": "external_digital",
  "digital2": "external_digital_2",
  "distance": "external_distance",
  "irInternalTemperature": "internal_ir_temperature",
  "irExternalTemperature": "external_ir_temperature",
  "waterleak": "external_water_leak",
  "soundPeak": "sound_peak",
  "soundAvg": "sound_avg",
  "tvoc": "voc"
};

function _remapKeys(obj) {
  var out = {};
  for (var k in obj) {
    var nk = ELSYS_KEY_MAP[k] || k;
    out[nk] = obj[k];
  }
  return out;
}

function _decode(bytes) { return _remapKeys(DecodeElsysPayload(bytes)); }
