// INTEGRA Metering aquastream Radio L8 (LoRaWAN) payload decoder
// Self-implemented from official INTEGRA Metering documentation:
//   - "Protocol aquastream" 9-730-PT-EN-08, section 4.5 "OMS over LoRaWAN"
//     (telegram = wM-Bus standard telegram §3.2, encryption mode 0, CRC removed;
//      RECORD1 main volume, RECORD2 reverse volume, RECORD3 error indicator,
//      RECORD4 remaining battery lifetime)
//   - "aquaradio MultiCom Protocol" 9-735-PT-EN-05, section 3.6/3.9 (same
//     OMS-over-LoRaWAN frame layout with documented example frames)
"use strict";
