...
var S2100_MEASUREMENT_ID_MAP = {
  ...
  '4190': 'uv_index',
  '4191': 'peak_wind_gust',
  '4192': 'sound_intensity_db',
  '4195': 'tvoc',
  '4197': 'longitude',
  '4198': 'latitude',
  '4201': 'ultraviolet_radiation',
  '4202': 'dew_point_temperature',
  '4213': 'rain_accumulation'
};

function s2100ToHex (bytes) {
  var hex = '';
...
function decodeUplink (input) {
  var raw = s2100ToHex(input.bytes);
  ...
  for (var i = 0; i < splitArray.length; i++) {
    ...
    for (var j = 0; j < messages.length; j++) {
      ...
      if (msg['Battery(%)'] !== undefined) {
        ...
        var mid = String(msg.measurementId);
        var field = S2100_MEASUREMENT_ID_MAP[mid] || ('measurement_' + mid);
        out[field] = msg.measurementValue;
      }
    }
  }
  return { data: out };
