// minol-zenner edc-communication-module — LoRaWAN payload decoder
// 字段清单来自官方 payload 说明（协议事实）；解析逻辑为自实现。
"use strict";
var FIELDS = ["pulse_count","removal_detection","battery_low","battery_end_of_life","hw_error","coil_manipulation"];
