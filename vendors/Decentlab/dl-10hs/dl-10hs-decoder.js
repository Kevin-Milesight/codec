    ...
    {length: 1,
     values: [{name: 'raw_sensor_reading',
              ...
              {name: 'volumetric_water_content',
               ...
               convert: function (x) { return (2.97*Math.pow(10, -9) * Math.pow(3000*(x[0]-32768)/32768, 3) - 7.37*Math.pow(10, -6) * Math.pow(3000*(x[0]-32768)/32768, 2) + 6.69*Math.pow(10, -3) * (3000*(x[0]-32768)/32768) - 1.92) * 100; },
               unit: '%'}]},
    {length: 1,
