// dnt dnt-lw-dis — LoRaWAN payload decoder
// 字段清单来自官方 payload 说明（协议事实）；解析逻辑为自实现。
"use strict";
var FIELDS = ["distance","acceleration","temperature","voltage","reason","status","device_type","fw_version","bl_version","hw_version","downlink_error"];
