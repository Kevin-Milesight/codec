// Sensing Labs SenlabA (SENLAB A - 4MA-LAB-41NS) LoRaWAN payload decoder
...
var MODEL_SLUG = "4ma-lab-41ns";
var MODEL_FAMILY = "SenlabA";
var DATALOG_PREFIX = 0x00;
...
function decodeDatalog(bytes, data) {
  ...
  // SenlabA：每 log 2 字节 MSB first，单位 1/200 mA
  if (bytes.length >= 7) {
    data.current = Math.round(u16be(bytes, bytes.length - 2) / 200 * 1000) / 1000;
  }
}
