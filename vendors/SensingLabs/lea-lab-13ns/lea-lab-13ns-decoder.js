// Sensing Labs SenlabD (SENLAB D - LEA-LAB-13NS) LoRaWAN payload decoder
...
var MODEL_SLUG = "lea-lab-13ns";
var MODEL_FAMILY = "SenlabD";
var DATALOG_PREFIX = 0x05;
...
function decodeDatalog(bytes, data) {
  ...
  // 主测量字段字节布局未从官方文档确证（见汇总 missingLayout），仅输出电量
}
