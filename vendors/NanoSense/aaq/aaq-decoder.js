// NanoSense AAQ (Atmospheric Air Quality probe) LoRaWAN payload decoder
// Self-implemented from the official vendor document:
//   "Atmospheric or Outdoor Air Quality Probe - LoRa or LoRaWAN" (AAQ-LoRa-Setting.pdf)
//   and "Parametrage de la sonde de Qualite de l'Air Atmospherique en mode LoRa
//   ou LoRaWAN" (QAA-Parametrage-LoRa.pdf, V6, which embeds the official Objenious
//   codec confirming the bit layout), chapters 3.2.1 / 3.2.1.
