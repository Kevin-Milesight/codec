...
function _atimDecode(bytes,fPort){
  ...
  if(out.temperature0!==undefined){out.first_temperature=out.temperature0;delete out.temperature0;}
  if(out.temperature1!==undefined){out.second_temperature=out.temperature1;delete out.temperature1;}
