...
function _atimDecode(bytes, fPort) {
  try {
    ...
    if (d.compteur1 && d.compteur1.value !== undefined) out.meter_1 = d.compteur1.value;
    if (d.compteur2 && d.compteur2.value !== undefined) out.meter_2 = d.compteur2.value;
