...
function decode(bytes, fPort) {
  ...
  if (d.Temp!==undefined) out.temperature=d.Temp;
  if (d.Illuminance!==undefined) out.illuminance=d.Illuminance;
  if (d.Occupy!==undefined) out.occupied=d.Occupy?1:0;
  if (d.DisassembledAlarm!==undefined) out.disassembled_alarm=d.DisassembledAlarm?1:0;
