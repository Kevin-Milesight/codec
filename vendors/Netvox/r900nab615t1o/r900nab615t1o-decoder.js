...
function decode(bytes, fPort) {
  ...
  if (d.Current1!==undefined){ var c=String(d.Current1).match(/\d+/); out.current_transformer1 = c?parseInt(c[0],10):d.Current1; }
  if (d.ShockTamperAlarm!==undefined) out.shockalarm = (d.ShockTamperAlarm==='Alarm') ? 1 : 0;
