    ...
    for (var i = 0; i < bytes.length;) {
        ...
        switch (command_id) {
            ...
            case 0x05:
                ...
                decoded.temperature_control_status = readTemperatureControlStatus((temperature_control_data >>> 4) & 0x0F);
                decoded.temperature_control_mode = readTemperatureControlMode((temperature_control_data >>> 0) & 0x0F);
                i += 1;
                break;
            case 0x06:
            ...
            case 0x07:
                ...
                decoded.fan_status = readFanStatus((fan_data >>> 4) & 0x0F);
                decoded.fan_mode = readFanMode((fan_data >>> 0) & 0x0F);
                i += 1;
                break;
            case 0x08:
