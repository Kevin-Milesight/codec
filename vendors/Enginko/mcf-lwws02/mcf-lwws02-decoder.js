// enginko mcf-lwws02 — LoRaWAN payload decoder
// 字段清单来自官方 payload 说明（协议事实）；解析逻辑为自实现。
"use strict";
var FIELDS = ["temperature","humidity","pressure","wind_speed","wind_direction","rainfall","data","syncid","syncversion","applicationtype","rfu"];
