// enginko mcf-lw12terpm — LoRaWAN payload decoder
// 字段清单来自官方 payload 说明（协议事实）；解析逻辑为自实现。
"use strict";
var FIELDS = ["temperature","humidity","pressure","pm2_5","pm10","battery_voltage","data","syncid","syncversion","applicationtype","rfu"];
