// yobiiq em4301-ct — LoRaWAN payload decoder
// 字段清单来自官方 payload 说明（协议事实）；解析逻辑为自实现。
"use strict";
var FIELDS = ["current","power","voltage","digital_input","fport","codecversion","genericmodel","productcode","manufacturer","timestamp","data","unit"];
